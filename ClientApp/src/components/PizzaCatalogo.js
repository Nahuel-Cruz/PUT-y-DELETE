...
export class PizzaCatalogo extends Component {
    ...
    eliminar = () => {
        ...
        console.log("id pizza: "+this.state.pizzaE.id )
    ...
    eli = (item) => {
            ...
            this.setState({accion: 3, pizzaE: item})
        ...
        return (
            <div>
                                ...
                                this.state.data.map(pizza =>
                                    <tr key={pizza.id}>
                                        ...
                                        <td><Button color="primary" onClick={() => this.editar(pizza)} >
                                            ...
                                            <Button color="primary" onClick={() => this.eli(pizza)}>
                                                X
                                            </Button>
                                        </td>
                                    </tr>
                ...
                <div>
                   ...
                   centered
                   toggle={this.miElimnar}
                    >
                        <ModalHeader toggle={this.toggle}>Eliminar Pizza</ModalHeader>
                        <ModalBody>
                            DESEA ELIMINAR LA PIZZA
                        </ModalBody>
                        <ModalFooter>
                            <Button color="success" onClick={() => this.eliminar()}>Continiar</Button>{' '}
                            <Button color="danger" onClick={this.mitoogle}>Cancelar</Button>
                        </ModalFooter>
                    </Modal>
                </div>
